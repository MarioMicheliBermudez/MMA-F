        ...
        if (isset($_POST["ip"])) {
            ...
            if (in_array("ping", $allowed_commands)) {
                ...
                if (filter_var($input, FILTER_VALIDATE_IP)) {
                    exec("ping -c 3 " . escapeshellarg($input), $out);
                    if (!empty($out)) {
                        ...
                        echo '<div class="alert alert-danger" role="alert" style="width:500px;"><strong><p style="text-align:center;">No response from ping command.</p></strong></div>';
                    }
                } else {
                    echo '<div class="alert alert-danger" role="alert" style="width:500px;"><strong><p style="text-align:center;">Invalid IP address.</p></strong></div>';
                }
            } else {
                echo '<div class="alert alert-danger" role="alert" style="width:500px;"><strong><p style="text-align:center;">Command not allowed.</p></strong></div>';
            }
        }
        ?>
    </div>
